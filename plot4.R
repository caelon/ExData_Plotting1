...
png(file="plot4.png")
par(mfcol=c(2,2))
plot(powerData$Global_active_power~powerData$DateTime, type="l",main="", ylab="Global Active Power", xlab="")
...
plot(powerData$Voltage~powerData$DateTime, type="l",main="", ylab="Voltage", xlab="datetime")
plot(powerData$Global_reactive_power~powerData$DateTime, type="l",main="", ylab="Global_reactive_power", xlab="datetime")
dev.off()